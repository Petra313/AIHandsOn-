...
triangle_coords = [(707,1082), (1925,379), (1915,1076)]
...
def draw_boxes(image, results):
  ...
  # drawing counts
  label_per = f'Per: {per_counter}'
  label_per2 = f'Per: {per_2}'
...
# Load the video
# TODO: put valid path
cap = cv2.VideoCapture('https://cdn-001.whatsupcams.com/hls/hr_murter03.m3u8')
